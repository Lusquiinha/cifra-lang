...
| `exemplos/fur_elise.cifra` | "Für Elise", de Beethoven (domínio público) — tema principal |
| `exemplos/rei_da_montanha.cifra` | "Na Caverna do Rei da Montanha", de Grieg (domínio público) — banda completa |
